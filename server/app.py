...
This module creates an HTTP server that exposes the TicketRouterEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m ticket_router.server.app
    ...
    multiple workers:
        uvicorn ticket_router.server.app:app --workers 4
    """
    import uvicorn
